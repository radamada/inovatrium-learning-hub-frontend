  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4">
      <div className="mb-6 relative">
        <span className="text-[120px] font-extrabold text-indigo-100 leading-none select-none">
          404
        </span>
        <GraduationCap className="absolute inset-0 m-auto w-16 h-16 text-indigo-400" />
      </div>
