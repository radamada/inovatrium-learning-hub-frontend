...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="hidden lg:flex fixed top-0 left-0 h-screen w-64 bg-gray-900 text-white flex-col z-30">
      ...
      {/* Mobile drawer */}
      <aside className={`fixed top-0 left-0 h-screen w-64 bg-gray-900 text-white flex flex-col z-50 transition-transform duration-300 lg:hidden ${
      ...
      <div className="lg:pl-64">
        ...
        <main className="max-w-6xl mx-auto p-4 pb-16 lg:p-6 lg:pb-16">{children}</main>
      </div>
    </div>
  );
}
