...
export const metadata = {
  title: 'Termeni și Condiții — Inovatrium Learning Hub',
  description: 'Termenii și condițiile de utilizare a platformei Inovatrium Learning Hub.',
};
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        ...
        <p>
          ...
          <strong>Inovatrium Learning Hub</strong> (<strong>learning.inovatrium.ro</strong>) presupune acceptarea în
          totalitate a prezentelor Termeni și Condiții. Dacă nu ești de acord cu acești termeni, te
          rugăm să nu utilizezi platforma. Inovatrium Learning Hub își rezervă dreptul de a modifica acești
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Platformă</strong> — website-ul și serviciile disponibile la adresa learning.inovatrium.ro.</li>
            ...
            <li><strong>Formator</strong> — persoana care creează și publică conținut educațional pe Platformă, în baza unui acord cu Inovatrium Learning Hub.</li>
            ...
            <li><strong>Contract</strong> — Comanda confirmată de Inovatrium Learning Hub, prin care Clientul dobândește acces la Cursurile achiziționate.</li>
            <li><strong>Operator</strong> — Inovatrium Learning Hub, societatea care administrează Platforma.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Inovatrium Learning Hub este o platformă online de educație care permite Utilizatorilor să acceseze
          ...
          <p className="mt-2">
            Inovatrium Learning Hub nu garantează că Platforma va fi disponibilă fără întreruperi și își rezervă
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>Notificarea imediată a Inovatrium Learning Hub în cazul suspiciunii de acces neautorizat</li>
          </ul>
          <p className="mt-2">
            Inovatrium Learning Hub își rezervă dreptul de a suspenda sau șterge fără preaviz conturile care
        ...
        <section>
          ...
          <p>
            ...
            Inovatrium Learning Hub își rezervă dreptul de a modifica prețurile în orice moment; prețul aplicat
          ...
          <p className="mt-2">
            ...
            <strong>Stripe</strong>. Inovatrium Learning Hub nu stochează datele de card ale Clienților.
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>Utilizarea conținutului în scop comercial fără acordul scris al Inovatrium Learning Hub</li>
            <li>Reproducerea sau crearea de materiale derivate din conținutul Cursurilor</li>
          </ul>
          <p className="mt-2">
            Inovatrium Learning Hub poate revoca accesul la un Curs dacă detectează utilizarea abuzivă a
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            <a href="mailto:contact@inovatrium.ro" className="text-blue-600 hover:underline">
        ...
        <section>
          ...
          <p>
            Tot conținutul disponibil pe Inovatrium Learning Hub — inclusiv cursuri video, texte, imagini,
            logo-uri, materiale grafice și denumiri comerciale — este protejat de drepturile de autor
            și aparține Inovatrium Learning Hub sau Formatorilor licențiatori, conform Legii nr. 8/1996
        ...
        <section>
          ...
          <p>
            Utilizatorii Platformei se obligă să nu utilizeze serviciile Inovatrium Learning Hub pentru activități
          ...
          <p className="mt-2">
            ...
            experiența directă cu Cursul evaluat. Inovatrium Learning Hub își rezervă dreptul de a șterge orice
        ...
        <section>
          ...
          <p>
            Inovatrium Learning Hub nu garantează că Platforma va funcționa fără erori, omisiuni sau
            întreruperi. Utilizatorul folosește Platforma pe propria răspundere. Inovatrium Learning Hub nu va
          ...
          <p className="mt-2">
            Responsabilitatea maximă a Inovatrium Learning Hub față de un Client nu va depăși suma totală plătită
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:legal@inovatrium.ro" className="text-blue-600 hover:underline">
              legal@inovatrium.ro
            </a>{' '}
            sau prin{' '}
            <Link href="/contact" className="text-blue-600 hover:underline">
