    ...
    <div className="bg-white dark:bg-slate-900">
      ...
      <section className="bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-20 px-4 text-center">
        ...
        >
          ...
          >
            Cum funcționează <span className="text-indigo-600 dark:text-indigo-400">Inoversity</span>?
          </motion.h1>
      ...
      <section className="py-20 px-4 text-center">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-slate-400 mb-8">
            Alătură-te miilor de studenți care învață zilnic pe Inoversity și dă-ți cariera un nou impuls.
          </p>
