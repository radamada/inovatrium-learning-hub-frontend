      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Email: <a href="mailto:privacy@inoversity.ro" className="text-indigo-600 hover:underline">privacy@inoversity.ro</a></li>
            <li>Formular de contact: <Link href="/contact" className="text-indigo-600 hover:underline">inoversity.ro/contact</Link></li>
          </ul>
        </section>
